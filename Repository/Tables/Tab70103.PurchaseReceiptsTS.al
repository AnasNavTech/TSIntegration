table 70103 "Purchase Receipts TS"
{
    Caption = 'Purchase Receipts Staging - TS';
    ...
    fields
    {
        ...
        field(7; "Quantity Good"; Decimal)
        {
            Caption = 'Quantity Good';
            DataClassification = CustomerContent;
        }
        field(8; "Quantity Damaged"; Decimal)
        {
            Caption = 'Quantity Damaged';
            DataClassification = CustomerContent;
        }
        field(9; "Quantity Rejected"; Decimal)
        {
            Caption = 'Quantity Rejected';
            DataClassification = CustomerContent;
        }
        field(10; "Entry Date and Time"; DateTime)
        {
            Caption = 'Entry Date and Time';
            DataClassification = CustomerContent;
        }
        field(11; "Processing Date and Time"; DateTime)
        {
            Caption = 'Processing Date and Time';
            DataClassification = CustomerContent;
        }
        field(12; "Integration Status"; Enum "Integration Status TS")
        {
        ...
        field(14; "Processing Remarks"; Text[100])
        {
            Caption = 'Processing Remarks';
            DataClassification = CustomerContent;
        }
        field(15; "Error Remarks"; Text[100])
        {
